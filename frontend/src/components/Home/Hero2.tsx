...
const Hero2: React.FC = () => {
  ...
  return (
    <div className="relative w-screen min-h-screen bg-slate-950 flex flex-col items-center">
      ...
      {isFlipped2 && (
        <div
          className={`absolute left-[200px] top-[180px] w-[500px] duration-500 ${
        ...
        >
          ...
          <p className="highlight text-gray-200 font-bold text-[20px] mt-3">
            우리의 웹사이트는 실시간으로 타로 리딩을 제공하는 플랫폼으로, 랜덤
            매칭을 통해 즉시 타로 리더와 연결되거나, AI 타로를 통해 간편하게
            해답을 얻을 수 있습니다. 또한, 예약 시스템을 이용해 원하는 타로
            리더와의 심층 상담을 진행할 수 있어, 언제 어디서나 여러분의 질문에
            대한 통찰을 받을 수 있습니다.
          </p>
        </div>
      )}
