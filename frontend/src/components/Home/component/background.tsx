...
const Hero1: React.FC = () => {
  return (
    <div className="relative bg-cover w-screen h-[600px] bg-opacity-10 bg-black">
      <img
        src={sunshine}
        alt="sunlens"
      ...
      <img
        src={planet2}
        alt=""
        className="w-[400px] absolute left-[100px] -bottom-[20px]"
      />
      <img
        src={planet3}
        alt=""
        className="opacity-60 w-[30px] absolute left-[30px] top-[30px]"
      />
      <img
        src={planet5}
        alt=""
        className="w-[80px] absolute left-[100px] top-[90px] opacity-70"
      />
      <img
        src={shine1}
        alt=""
        className="w-[150px] absolute top-[200px] opacity-80"
      />
      <img
        src={shine2}
        alt=""
        className="w-[150px] absolute left-[300px] -top-[50px] opacity-70"
      />
    </div>
  );
};
